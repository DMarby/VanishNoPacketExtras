...
public abstract class Config {
	...
	private boolean doSkip(Field field) {
		return Modifier.isPrivate(field.getModifiers()) || Modifier.isTransient(field.getModifiers()) || Modifier.isStatic(field.getModifiers()) || Modifier.isFinal(field.getModifiers());
	}
